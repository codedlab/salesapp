...
it("fails when an email does not exist", function () { return __awaiter(void 0, void 0, void 0, function () {
...
it("responds with a cookie when given a vaild credentials", function () { return __awaiter(void 0, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, supertest_1.default(app_1.app)
